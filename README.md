...
更完整的理念、三端截图与擂台说明见下方正文。需要「从写到上线变现该选哪一层」时，直接进 [A–V 图廓](#上线路程--av-图廓)。
...
> **[在线像素论剑](https://arena.megoclick.com/pixel.html)** —— 免登录；主站首页「像素论剑」亦指向同一地址。
...
- ✅ 选型擂台（挂 B 卷）：13 擂台 / 三模式 / 造擂分享码（闭源，[可玩](https://arena.megoclick.com/pixel.html)）
